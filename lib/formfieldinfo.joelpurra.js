...
(function($, _, namespace) {
    ...
    ns.getFields = function(selector, $context) {
        ...
        $context.find(selector).each(function(index) {
    ...
    var fieldGroupsMixins = {
        ...
        nameValues: function(fieldGroups) {
            var groups = _(fieldGroups).map(function(value, key, list) {
                ...
                function getValues() {
                    ...
                    if (first.$element.is("select")) {
                        var $options = first.$element.find("option");
        ...
        withMismatches: function(fieldGroups) {
            var withMismatches = _(fieldGroups).filter(function(value) {
                ...
                var tags = _.uniq(fieldsInGroup.pluck("tag")),
