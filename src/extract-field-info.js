/*jslint white:true, todo:true, plusplus:true, nomen:true, vars:true */
// The globals also include stuff that is execute in the phantomjs browser
/*global phantom:true, require:true, console:true, _:true, Q:true, JoelPurra:true, window:true, document:true, setTimeout:true */

(function(phantom, require, console, undefined) {
    "use strict";
    ...
    (function(global, _, Q) {
        ...
        debug.init = function() {
            ["log", "debug", "info", "warn", "error"].forEach(function(fnName, index) {
        ...
        modes.shared = function(done, address1, address2, more) {
            ...
            function afterFetched(fieldSummariesArray) {
                ...
                _fieldSummariesArray.each(function(fieldSummaries, index) {
                    debug.log(tag, "fieldSummaries", index, "[i].length", fieldSummaries.length);
                });

                shared = priv.getFieldSummariesIntersection(fieldSummariesArray);
        ...
        priv.printFieldSummaries = function(fieldSummaries) {
            ...
            _(fieldSummaries).each(function(fieldSummary) {
        ...
        _generalMixins.filterPropertyEq = function(list, propertyName, value) {
            var filtered = _(list).filter(function(inner) {
        ...
        _generalMixins.intersectionPropertyEq = function(lists, propertyName) {
            ...
            var duplicates = union.filter(function(val) {
            ...
            var intersection = duplicates.filter(function(val) {
